import { Tender, User, Document, ChatMessage, KPIData } from '../types/tender';
...
export const mockChatMessages: ChatMessage[] = [
  {
    ...
    message: 'I\'ve reviewed the technical requirements. We need to clarify the infrastructure specs.',
  ...
  },
  {
    ...
    userId: '2',
    userName: 'Bob Smith',
    userAvatar: 'https://images.pexels.com/photos/697509/pexels-photo-697509.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop',
    message: 'Agreed. I\'ll reach out to the client for additional technical documentation.',
  ...
  },
  {
    ...
    message: 'The financial proposal is ready for review. Please check the pricing structure.',
